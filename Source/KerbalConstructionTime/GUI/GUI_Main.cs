        ...
        public static void SetGUIPositions()
        {
            ...
            if (_validScenes.Contains(HighLogic.LoadedScene))
            {
                ...
                if (GUIStates.ShowAirlaunch && !GUIStates.ShowClearLaunch)
                    _buildPlansWindowPosition = ClickThruBlocker.GUILayoutWindow(WindowHelper.NextWindowId("DrawAirlaunchWindow"), _buildPlansWindowPosition, DrawAirlaunchWindow, "Airlaunch", HighLogic.Skin.window);
