...
namespace KerbalConstructionTime
{
    ...
    internal class InstallChecker : MonoBehaviour
    {
        ...
        private const string FOLDERNAME = "RP-0";
        ...
        protected void Start()
        {
            ...
            if (assemblies.Any())
            {
                ...
                Debug.Log("Incorrect " + MODNAME + " Installation: " + MODNAME + " has been installed incorrectly and will not function properly. All files should be located in KSP/GameData/" + EXPECTEDPATH +
